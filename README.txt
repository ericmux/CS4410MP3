...
Mailbox Backup (optional for CS 4411 students)
------------
...
You will also have a separate upload for QUESTIONS.txt . If it is not uploaded to 
CMS as well as the zip file we will not know to grade it.

If this structure is not maintained, our grader will not be able to grade your files 
and minus points will be given for improper structure.


If you have any questions, do not hesitate to use Piazza or come to Office Hours.

*Note: Regrades for this project will only be accepted up until December 3rd at 
5:00pm.
